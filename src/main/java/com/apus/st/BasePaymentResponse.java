...
@XmlRootElement(name = "BasePaymentResponse")
public class BasePaymentResponse {
    ...
    protected BasePaymentResponse.Result result;
     ...
     * @return
     *     possible object is
     *     {@link BasePaymentResponse.Result }
     *     
     */
    public BasePaymentResponse.Result getResult() {
        return result;
    }
     ...
     *     
     */
    public void setResult(BasePaymentResponse.Result value) {
        this.result = value;
    }
