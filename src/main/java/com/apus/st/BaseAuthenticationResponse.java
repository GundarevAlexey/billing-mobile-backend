...
@XmlRootElement(name = "BaseAuthenticationResponse")
public class BaseAuthenticationResponse {

    @XmlElement(name = "UserLang")
    protected String userLang;
    @XmlElement(name = "Result")
    protected BaseAuthenticationResponse.Result result;
     ...
     * @return
     *     possible object is
     *     {@link BaseAuthenticationResponse.Result }
     *     
     */
    public BaseAuthenticationResponse.Result getResult() {
        return result;
    }
     ...
     *     
     */
    public void setResult(BaseAuthenticationResponse.Result value) {
        this.result = value;
    }
