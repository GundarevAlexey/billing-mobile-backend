...
@XmlRootElement(name = "BaseRegisterNewCardResponse")
public class BaseRegisterNewCardResponse {

    @XmlElement(name = "Result")
    protected BaseRegisterNewCardResponse.Result result;
     ...
     * @return
     *     possible object is
     *     {@link BaseRegisterNewCardResponse.Result }
     *     
     */
    public BaseRegisterNewCardResponse.Result getResult() {
        return result;
    }
     ...
     *     
     */
    public void setResult(BaseRegisterNewCardResponse.Result value) {
        this.result = value;
    }
