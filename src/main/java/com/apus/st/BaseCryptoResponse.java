...
@XmlRootElement(name = "BaseCryptoResponse")
public class BaseCryptoResponse {

    @XmlElement(name = "Crypto")
    protected String crypto;
    @XmlElement(name = "Result")
    protected BaseCryptoResponse.Result result;
     ...
     * @return
     *     possible object is
     *     {@link BaseCryptoResponse.Result }
     *     
     */
    public BaseCryptoResponse.Result getResult() {
        return result;
    }
     ...
     *     
     */
    public void setResult(BaseCryptoResponse.Result value) {
        this.result = value;
    }
