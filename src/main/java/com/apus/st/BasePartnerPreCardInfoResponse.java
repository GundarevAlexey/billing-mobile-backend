...
@XmlRootElement(name = "BasePartnerPreCardInfoResponse")
public class BasePartnerPreCardInfoResponse {

    @XmlElement(name = "Result")
    protected BasePartnerPreCardInfoResponse.Result result;
     ...
     * @return
     *     possible object is
     *     {@link BasePartnerPreCardInfoResponse.Result }
     *     
     */
    public BasePartnerPreCardInfoResponse.Result getResult() {
        return result;
    }
     ...
     *     
     */
    public void setResult(BasePartnerPreCardInfoResponse.Result value) {
        this.result = value;
    }
