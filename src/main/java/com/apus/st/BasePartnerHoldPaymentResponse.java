...
@XmlRootElement(name = "BasePartnerHoldPaymentResponse")
public class BasePartnerHoldPaymentResponse {

    @XmlElement(name = "Result")
    protected BasePartnerHoldPaymentResponse.Result result;
     ...
     * @return
     *     possible object is
     *     {@link BasePartnerHoldPaymentResponse.Result }
     *     
     */
    public BasePartnerHoldPaymentResponse.Result getResult() {
        return result;
    }
     ...
     *     
     */
    public void setResult(BasePartnerHoldPaymentResponse.Result value) {
        this.result = value;
    }
