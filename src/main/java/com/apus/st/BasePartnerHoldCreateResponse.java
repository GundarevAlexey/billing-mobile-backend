...
@XmlRootElement(name = "BasePartnerHoldCreateResponse")
public class BasePartnerHoldCreateResponse {

    @XmlElement(name = "Result")
    protected BasePartnerHoldCreateResponse.Result result;
     ...
     * @return
     *     possible object is
     *     {@link BasePartnerHoldCreateResponse.Result }
     *     
     */
    public BasePartnerHoldCreateResponse.Result getResult() {
        return result;
    }
     ...
     *     
     */
    public void setResult(BasePartnerHoldCreateResponse.Result value) {
        this.result = value;
    }
