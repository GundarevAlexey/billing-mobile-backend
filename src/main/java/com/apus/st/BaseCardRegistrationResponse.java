...
@XmlRootElement(name = "BaseCardRegistrationResponse")
public class BaseCardRegistrationResponse {

    @XmlElement(name = "Result")
    protected BaseCardRegistrationResponse.Result result;
     ...
     * @return
     *     possible object is
     *     {@link BaseCardRegistrationResponse.Result }
     *     
     */
    public BaseCardRegistrationResponse.Result getResult() {
        return result;
    }
     ...
     *     
     */
    public void setResult(BaseCardRegistrationResponse.Result value) {
        this.result = value;
    }
