...
@XmlRootElement(name = "BaseCheckTransactionOneTimeVisaResponse")
public class BaseCheckTransactionOneTimeVisaResponse {
    ...
    protected BaseCheckTransactionOneTimeVisaResponse.Result result;
     ...
     * @return
     *     possible object is
     *     {@link BaseCheckTransactionOneTimeVisaResponse.Result }
     *     
     */
    public BaseCheckTransactionOneTimeVisaResponse.Result getResult() {
        return result;
    }
     ...
     *     
     */
    public void setResult(BaseCheckTransactionOneTimeVisaResponse.Result value) {
        this.result = value;
    }
