...
@XmlRootElement(name = "BaseKvitansiaParamsResponse")
public class BaseKvitansiaParamsResponse {
    ...
    protected BaseKvitansiaParamsResponse.Result result;
     ...
     * @return
     *     possible object is
     *     {@link BaseKvitansiaParamsResponse.Result }
     *     
     */
    public BaseKvitansiaParamsResponse.Result getResult() {
        return result;
    }
     ...
     *     
     */
    public void setResult(BaseKvitansiaParamsResponse.Result value) {
        this.result = value;
    }
