...
@XmlRootElement(name = "BaseP2PInfoResponse")
public class BaseP2PInfoResponse {
    ...
    protected BaseP2PInfoResponse.Result result;
     ...
     * @return
     *     possible object is
     *     {@link BaseP2PInfoResponse.Result }
     *     
     */
    public BaseP2PInfoResponse.Result getResult() {
        return result;
    }
     ...
     *     
     */
    public void setResult(BaseP2PInfoResponse.Result value) {
        this.result = value;
    }
