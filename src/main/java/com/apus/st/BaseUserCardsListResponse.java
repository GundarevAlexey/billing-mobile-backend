...
@XmlRootElement(name = "BaseUserCardsListResponse")
public class BaseUserCardsListResponse {

    @XmlElement(name = "Result")
    protected BaseUserCardsListResponse.Result result;
     ...
     * @return
     *     possible object is
     *     {@link BaseUserCardsListResponse.Result }
     *     
     */
    public BaseUserCardsListResponse.Result getResult() {
        return result;
    }
     ...
     *     
     */
    public void setResult(BaseUserCardsListResponse.Result value) {
        this.result = value;
    }
