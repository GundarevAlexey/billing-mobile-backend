...
@XmlRootElement(name = "BaseUserInformationGetResponse")
public class BaseUserInformationGetResponse {

    @XmlElement(name = "Result")
    protected BaseUserInformationGetResponse.Result result;
     ...
     * @return
     *     possible object is
     *     {@link BaseUserInformationGetResponse.Result }
     *     
     */
    public BaseUserInformationGetResponse.Result getResult() {
        return result;
    }
     ...
     *     
     */
    public void setResult(BaseUserInformationGetResponse.Result value) {
        this.result = value;
    }
