...
@XmlRootElement(name = "BaseP2PPaymentConfirmResponse")
public class BaseP2PPaymentConfirmResponse {

    @XmlElement(name = "Result")
    protected BaseP2PPaymentConfirmResponse.Result result;
     ...
     * @return
     *     possible object is
     *     {@link BaseP2PPaymentConfirmResponse.Result }
     *     
     */
    public BaseP2PPaymentConfirmResponse.Result getResult() {
        return result;
    }
     ...
     *     
     */
    public void setResult(BaseP2PPaymentConfirmResponse.Result value) {
        this.result = value;
    }
