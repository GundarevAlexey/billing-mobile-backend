...
@XmlRootElement(name = "BasePaymentOneTimeVisaResponse")
public class BasePaymentOneTimeVisaResponse {
    ...
    protected BasePaymentOneTimeVisaResponse.Result result;
     ...
     * @return
     *     possible object is
     *     {@link BasePaymentOneTimeVisaResponse.Result }
     *     
     */
    public BasePaymentOneTimeVisaResponse.Result getResult() {
        return result;
    }
     ...
     *     
     */
    public void setResult(BasePaymentOneTimeVisaResponse.Result value) {
        this.result = value;
    }
