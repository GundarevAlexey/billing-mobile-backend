...
@XmlRootElement(name = "BasePartnerPaymentResponse")
public class BasePartnerPaymentResponse {

    @XmlElement(name = "Result")
    protected BasePartnerPaymentResponse.Result result;
     ...
     * @return
     *     possible object is
     *     {@link BasePartnerPaymentResponse.Result }
     *     
     */
    public BasePartnerPaymentResponse.Result getResult() {
        return result;
    }
     ...
     *     
     */
    public void setResult(BasePartnerPaymentResponse.Result value) {
        this.result = value;
    }
